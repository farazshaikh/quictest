...
async function keyPairRSAToPEM({ publicKey, privateKey, }) {
 ...
 * ```
 */
async function createX509SelfSigned(alg, keys) {
...
async function main() {
    ...
    const certRSAPEM = certRSA.toString("pem");
    /* Build HMAC */
